        ...
        <div className="mt-10  dark:bg-[#140C1C] p-4 rounded-md ">
          <div className="space-y-4">
            ...
            <p className="text-[#989BA4] text-base leading-relaxed">
              ...
              websites. My journey started in 2023-July-02, and since then, I
              have been focused on creating impactful digital experiences.
            </p>
            {/* skills */}
            <div>
              ...
              <div className="space-y-4">
                ...
                <ul className="text-[#989BA4] text-base leading-relaxed list-disc list-inside">
                  ...
                  <li>
                    ...
                    Redux Toolkit, React Query, TanStack Table
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div>
              ...
              <ul className="text-[#989BA4] text-base leading-relaxed space-y-4">
                ...
                <li>
                  ...
                  Built a dynamic flight booking system with Redux, allowing
                  users to search, book, and manage reservations.
                </li>
                <li>
                  <span className="font-semibold">
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <p className="text-[#989BA4] text-base leading-relaxed">
                  ...
                  environments where knowledge-sharing, constructive feedback,
                  and collective problem-solving lead to better outcomes. I
                  strongly value clear communication and a growth mindset in
